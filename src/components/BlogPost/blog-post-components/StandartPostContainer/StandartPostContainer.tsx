    ...
    <>
      ...
      <div className={entryContent}>
        <p>
          ...
          Movement. Why the Western world’s been fancying the conventional
          Zodiac system, hence the one created further east – believed to be
          originally a creation of the Egyptians, later on adopted by the
          Babylonians and then historically spread across the rest of the
          ancient world.
        </p>
        <p>
        ...
        <div className={socialNetworksContent}>
          <ul
            className={classNames(
              socialNetworks,
              "flex grid sm:grid-cols-5 grid-cols-4",
            )}
          >
            <li className="flex">
